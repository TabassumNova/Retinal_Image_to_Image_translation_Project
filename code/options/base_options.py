...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--grayscaleA', action='store_true', help='Convert input images A to grayscale - as 3 channels')
        parser.add_argument('--grayscaleB', action='store_true', help='Convert input images B to grayscale - as 3 channels')
        parser.add_argument('--invertA', action='store_true', help='Invert input images A') 
        parser.add_argument('--invertB', action='store_true', help='Invert input images A') 
        ...
        parser.add_argument('--nameA', type=str, default='photo', help='photo, print, paint etc')
        parser.add_argument('--nameB', type=str, default='print', help='photo, print, paint etc')		
